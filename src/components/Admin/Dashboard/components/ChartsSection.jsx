  ...
  return (
    <div className={styles.mainGrid}>
      ...
      <div className={styles.card}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
          <div>
            ...
            <span className={styles.cardSubtitle}>Daily revenue in EGP</span>
          </div>
          {/* Custom HTML Legend */}
      ...
      <div className={styles.card}>
        ...
        <span className={styles.cardSubtitle}>All orders this period</span>
  ...
  if (active && payload && payload.length) {
    return (
      <div className={styles.tooltip}>
        ...
        <p className={styles.tooltipVal} style={{color: '#97c459'}}>Profit: {payload[1].value.toLocaleString()} EGP</p>
      </div>
    );
  }
  return null;
